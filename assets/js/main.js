...
(function () {
  "use strict";
  var I18N={pl:{"form.error.required":"To pole jest wymagane.","form.error.email":"Podaj poprawny adres e-mail.","form.error.summary":"Uzupełnij zaznaczone pola.","form.sending":"Otwieramy Twój program pocztowy z gotową wiadomością.","form.fallback":"Jeśli nic się nie otworzyło, napisz bezpośrednio na {email}.","nav.menu":"Menu","date.locale":"pl-PL"}};
  var LANG=(document.documentElement.lang||"pl").slice(0,2),DICT=I18N[LANG]||I18N.pl;
  function t(key,vars){var s=DICT[key]||I18N.pl[key]||key;if(vars)Object.keys(vars).forEach(function(k){s=s.replace("{"+k+"}",vars[k]);});return s;}
